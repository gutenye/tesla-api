...
function _class2(callback,delay){_classCallCheck(this,_class2);this.id=null;
this.callback=callback;
this.delay=delay;}_createClass(_class2,[{key:"start",value:function start()
...
return;
this.callback();
this.id=setInterval(this.callback,this.delay);}},{key:"stop",value:function stop()


{
clearInterval(this.id);
this.id=null;}}]);return _class2;}();
...
var result={};for(var _len=arguments.length,keys=Array(_len>1?_len-1:0),_key=1;_key<_len;_key++){keys[_key-1]=arguments[_key];}
